...
_For 1.16.5 or older_ there's a workaround in installing an older Java binary. Mojang Java 8u51 is recommended, and can be automatically installed with the [above](<#automatically-installing-java-(recommended)>).
