...
In order to transfer an instance, or multiple instances from MultiMC to MeshMC, you must begin the process by opening MultiMC on your computer.
...
## <img src="https://raw.githubusercontent.com/Project-Tick/MeshMC/develop/branding/org.projecttick.MeshMC.svg" alt="MeshMC Logo" width=30px style="display: inline-block"> In MeshMC

To complete the transfer process, you must now open MeshMC.
...
Now that the MeshMC instance directory is open, you may **paste** the instance(s) that you previously copied from the MultiMC directory.

_Optional: If you would like to transfer your pack icon selections, navigate up from the MultiMC instances folder to the main MultiMC folder. Do the same for MeshMC. Copy the_ **icons** _folder from MultiMC to MeshMC._

## Finishing up

Now, in **MeshMC**, your instances should appear as they normally would in MultiMC.
