...
Once you have picked out your ideal mod loader, go to the **Mods** tab, and select the **Download Mods** option that's to the right. From here, you can choose to install from both _Modrinth_ and _CurseForge_ services. Modrinth focuses more towards free and open-source mods and is generally recommended, however, some older mods may only exist on CurseForge.
