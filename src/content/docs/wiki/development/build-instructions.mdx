...
:::caution
The installation of `vcpkg` bundled with VS 2026 is currently broken, and is thus not recommended. You can read more about this [here](https://developercommunity.visualstudio.com/t/Bundled-vcpkg-is-unusable/10998815).

As a workaround, you can `git clone` the repository at `https://github.com/Microsoft/vcpkg` and set `VCPKG_ROOT` to its location.

**This does not affect VS 2022!**
:::
